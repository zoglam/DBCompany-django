...
urlpatterns = [
    ...
    url(r'^Payment/(?P<pk>\d+)/delete/$',
        views.delete_payment, name='delete_payment'),
    ...
    url(r'^Factory/(?P<pk>\d+)/delete/$',
        views.delete_factory, name='delete_factory'),
    url(r'^Factory/(?P<pk>\d+)/good/', views.good_new, name='good_new'),
    url(r'^Factory/(?P<pk>\d+)/transport/',
        views.transport_new, name='transport_new'),
